...
public class CommonController
{
    ...
    public void downloadFile(String fileName,String filePath, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            int index = filePath.lastIndexOf("upload");//获取第一个upload的位置
            String afterPath = filePath.substring(index);
            // 组装后的文件路径
            String realPath = Global.getDownloadPath() + afterPath;
