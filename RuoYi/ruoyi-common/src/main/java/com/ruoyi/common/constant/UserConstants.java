...
public class UserConstants
{
    ...
    /** 实名初始状态 */
    public static final String AURH_NORMAL = "0";

    /** 实名待审核状态 */
    public static final String AURH_CHECK = "1";

    /** 实名合格状态 */
    public static final String AURH_ACC = "2";

    /** 实名不合格状态 */
    public static final String AURH_REJ = "3";
